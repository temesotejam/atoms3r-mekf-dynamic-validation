...
static constexpr uint32_t IMU_POLL_PERIOD_US = 2500UL;  // V46w: poll once per nominal 400 Hz gyro period.
...
static constexpr char ATTITUDE_VALIDATION_REVISION[] = "v46w_imu_poll_2500us_20260918";
