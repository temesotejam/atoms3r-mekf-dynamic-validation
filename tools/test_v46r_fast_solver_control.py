...
assert 'v46ah_full_rate_baseline_20260919' in config
assert manifest['version'] == '0.46.33'
assert 'V46ah' in manifest['name']
assert 'V46ah / 0.46.33' in site
...
# V46ah physical selector uses the bounded fast search, not the 0..100 exhaustive scans.
...
print('V46ah fast physical selector + legacy zero-output semantics + unchanged safety guards PASS')
