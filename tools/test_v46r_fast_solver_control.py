...
assert manifest['version'] == '0.46.30'
assert 'V46ae' in manifest['name']
assert 'V46ae / 0.46.30' in site
...
# V46ae physical selector uses the bounded fast search, not the 0..100 exhaustive scans.
...
print('V46ae fast physical selector + legacy zero-output semantics + unchanged safety guards PASS')
