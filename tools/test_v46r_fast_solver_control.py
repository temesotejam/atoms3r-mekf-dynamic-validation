...
assert manifest['version'] == '0.46.34'
assert 'V46ai' in manifest['name']
assert 'V46ai / 0.46.34' in site
...
# V46ai physical selector uses the bounded fast search, not the 0..100 exhaustive scans.
...
print('V46ai fast physical selector + legacy zero-output semantics + unchanged safety guards PASS')
