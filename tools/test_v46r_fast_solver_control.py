...
assert 'v46u_timing_reader_20260915' in config
assert manifest['version'] == '0.46.20'
assert 'V46u' in manifest['name']
assert 'V46u / 0.46.20' in site
...
# V46u physical selector uses the bounded fast search, not the 0..100 exhaustive scans.
...
print('V46u fast physical selector + legacy zero-output semantics + unchanged safety guards PASS')
