...
assert manifest['version'] == '0.46.28'
assert 'V46ac' in manifest['name']
assert 'V46ac / 0.46.28' in site
...
# V46ac physical selector uses the bounded fast search, not the 0..100 exhaustive scans.
...
print('V46ac fast physical selector + legacy zero-output semantics + unchanged safety guards PASS')
