...
assert manifest['version'] == '0.46.27'
assert 'V46ab' in manifest['name']
assert 'V46ab / 0.46.27' in site
...
# V46ab physical selector uses the bounded fast search, not the 0..100 exhaustive scans.
...
print('V46ab fast physical selector + legacy zero-output semantics + unchanged safety guards PASS')
