...
assert 'v46y_frozen_imu_1ms_20260918' in config
assert manifest['version'] == '0.46.24'
assert 'V46y' in manifest['name']
assert 'V46y / 0.46.24' in site
...
# V46y physical selector uses the bounded fast search, not the 0..100 exhaustive scans.
...
print('V46y fast physical selector + legacy zero-output semantics + unchanged safety guards PASS')
