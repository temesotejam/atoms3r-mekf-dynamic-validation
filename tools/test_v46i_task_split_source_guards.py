...
assert ('v46l_fast_solver_shadow_20260914' in config or
        'v46ag_rate_baseline_20260919' in config)
...
assert ('AtomS3R V46q MEKF Motor Validation' in manifest or
        'AtomS3R V46ag Fast Solver Motor Validation' in manifest)
assert ('"version": "0.46.16"' in manifest or '"version": "0.46.32"' in manifest)
