...
assert ('v46l_fast_solver_shadow_20260914' in config or
        'v46t_current_observation_20260915' in config)
...
assert ('AtomS3R V46q MEKF Motor Validation' in manifest or
        'AtomS3R V46t Fast Solver Motor Validation' in manifest)
assert ('"version": "0.46.16"' in manifest or '"version": "0.46.19"' in manifest)
