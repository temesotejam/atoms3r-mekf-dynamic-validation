...
assert ('v46l_fast_solver_shadow_20260914' in config or
        'v46ac_light_delay_compensation_20260918' in config)
...
assert ('AtomS3R V46q MEKF Motor Validation' in manifest or
        'AtomS3R V46ac Fast Solver Motor Validation' in manifest)
assert ('"version": "0.46.16"' in manifest or '"version": "0.46.28"' in manifest)
