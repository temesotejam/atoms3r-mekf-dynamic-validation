...
def main():
    ...
    for token in ['BMI270_GYRO_ODR_HZ = 400','BMI270_ACCEL_ODR_HZ = 200','IMU_POLL_PERIOD_US = 2500UL','CURRENT_AUDIT_FAST_READ_PERIOD_US = 1000UL','BMI270_I2C_HZ = 1000000UL']:
...
''')
    ...
    assert not assess(bad)['imu_control_observed_pass']
    print('PASS: unchanged controller/estimators/ODR/safety; V46w 1MHz IMU + 1ms current audit guards; real deadline counters')
